...
export const ZoneStandardShape = {
  ...
  icon: z.number().int().describe('Zone icon id. Required upstream — Hydrawise rejects null with "Missing icon" despite the GraphQL schema marking it optional. Fetch the current value via get_zone_settings if you do not intend to change it.'),
